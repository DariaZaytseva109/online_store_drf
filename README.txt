...
endpoint: basketproduct/add/             # добавление продукта в корзину
endpoint: basketproduct/<int:pk>/        # изменение кол-ва и удаление продукта из корзины
